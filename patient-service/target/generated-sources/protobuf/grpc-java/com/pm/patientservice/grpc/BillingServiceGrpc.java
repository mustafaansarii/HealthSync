...
public final class BillingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.pm.patientservice.grpc.BillingRequest,
      com.pm.patientservice.grpc.BillingResponse> getCreateBillingAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateBillingAccount",
      requestType = com.pm.patientservice.grpc.BillingRequest.class,
      responseType = com.pm.patientservice.grpc.BillingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.pm.patientservice.grpc.BillingRequest,
      com.pm.patientservice.grpc.BillingResponse> getCreateBillingAccountMethod() {
    io.grpc.MethodDescriptor<com.pm.patientservice.grpc.BillingRequest, com.pm.patientservice.grpc.BillingResponse> getCreateBillingAccountMethod;
      ...
      synchronized (BillingServiceGrpc.class) {
        if ((getCreateBillingAccountMethod = BillingServiceGrpc.getCreateBillingAccountMethod) == null) {
          BillingServiceGrpc.getCreateBillingAccountMethod = getCreateBillingAccountMethod =
              io.grpc.MethodDescriptor.<com.pm.patientservice.grpc.BillingRequest, com.pm.patientservice.grpc.BillingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateBillingAccount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pm.patientservice.grpc.BillingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pm.patientservice.grpc.BillingResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createBillingAccount(com.pm.patientservice.grpc.BillingRequest request,
        io.grpc.stub.StreamObserver<com.pm.patientservice.grpc.BillingResponse> responseObserver) {
  ...
  public static final class BillingServiceStub
    ...
    /**
     */
    public void createBillingAccount(com.pm.patientservice.grpc.BillingRequest request,
        io.grpc.stub.StreamObserver<com.pm.patientservice.grpc.BillingResponse> responseObserver) {
  ...
  public static final class BillingServiceBlockingStub
    ...
    /**
     */
    public com.pm.patientservice.grpc.BillingResponse createBillingAccount(com.pm.patientservice.grpc.BillingRequest request) {
  ...
  public static final class BillingServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.pm.patientservice.grpc.BillingResponse> createBillingAccount(
        com.pm.patientservice.grpc.BillingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BILLING_ACCOUNT:
          serviceImpl.createBillingAccount((com.pm.patientservice.grpc.BillingRequest) request,
              (io.grpc.stub.StreamObserver<com.pm.patientservice.grpc.BillingResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.pm.patientservice.grpc.BillingRequest,
              com.pm.patientservice.grpc.BillingResponse>(
  ...
  private static abstract class BillingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.pm.patientservice.grpc.BillingServiceOuterClass.getDescriptor();
    }
